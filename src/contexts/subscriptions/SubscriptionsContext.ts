...
import {
  SubscriptionsDispatchContextData,
  SubscriptionsStateContextData,
} from './types';
...
export const SubscriptionsDispatchProvider =
...
export const useSubscriptionsDispatch = () => {
  ...
  if (!context) {
    throw new Error(
      'useSubscriptionsDispatch must be used within a AuthProvider',
    );
  }
